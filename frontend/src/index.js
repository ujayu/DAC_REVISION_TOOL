...
import EmailVerify from './component/middle/EmailVerify';
import RevisionComplete from './component/middle/RevisionComplete';
...
const router  = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "revisionComplete",
        element: <RevisionComplete />,
      },
      {
